...
class MenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("backend.menu.index",compact("list","list_category","list_topic","list_brand","list_post","htmlposition"));
    }
    ...
    public function edit(string $id)
    {
        ...
        foreach ($list as $item){
            ...
            if($menu->id == $item->id){
                ...
                return view("backend.menu.edit",compact("menu","htmlparentid","htmlsortorder","htmlposition"));
    }
    /**
     ...
     public function destroy(string $id)
     {
        ...
        public function restore(string $id)
        {
            ...
            if ($menu) {
                ...
                $menu->save();
            // Redirect with success message
            return redirect()->route('admin.menu.trash')->with('success', 'menu updated successfully.');
           }
