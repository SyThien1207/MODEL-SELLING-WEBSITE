            ...
            <span>
              <h2 class="title">
                <div class="title-container">
                  {{$category->name}}
                  <form action="{{ route('product.product',['slug' => $category['slug']]) }}" method="GET" class="form-inline">
                    <div class="header-search-container">
                      ...
                      <div class="view-mode-row">
                        <label>
                          <input type="radio" name="view_mode" value="list" {{ request()->input('view_mode', 'list') == 'list' ? 'checked' : '' }}>
                          danh sách
                        </label>
                        <label>
                          <input type="radio" name="view_mode" value="grid" {{ request()->input('view_mode') == 'grid' ? 'checked' : '' }}>
                          grid
                        </label>
                      </div>
                    </div>
