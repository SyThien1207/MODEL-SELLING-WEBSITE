...
<style>
  ...
  .bbtn {
    border: 2px solid black; /* Viền đen với độ dày 2px */
    ...
    transition: background-color 0.3s, color 0.3s; /* Hiệu ứng chuyển đổi khi di chuột qua */
  }
                ...
                <form action="{{ route('product.index') }}" method="GET" class="form-inline">
                  <div class="header-search-container">
                    <div class="search-row">
                      ...
                      <div>
                        <button type="submit" class="bbtn">Tìm kiếm</button>
                      </div>
                    </div>
