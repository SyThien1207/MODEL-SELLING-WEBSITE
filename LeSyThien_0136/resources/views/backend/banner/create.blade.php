                     ...
                     <div class="row">
                        <div class="col-md-9">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" value="{{old('name')}}"  name="name" class="form-control" placeholder="Nhập tên banner" />
                           </div>
                           <div class="mb-3">
                              <label><strong>Liên kết</strong></label>
                              <input type="text"  value="{{old('link')}}" name="link" class="form-control" placeholder="Nhập liên kết" />
                           </div>
                           <div class="mb-3">
